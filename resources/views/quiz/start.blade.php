              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                                                             ...
                                                             <div class="quesrion-detil">
                                                                 ...
                                                                 <h2 id="ques_title"><?=$question->title?></h2>
...
<button type="button"  class="exam-next btn btn-success" id="next_button">Next</button>
            ...
            $( "#next_button" ).click(function() {
               ...
               var student_id = $('#student_id').val();
                ...
                $.ajax({
                        type: "GET",
                         data: {option: question_option , student_id: student_id, question_id: question_id,quiz_id:quiz_id,result_id:result_id},
                        url: submitUrl,
            ...
            window.location = redirectUrl;
             ...
             $( "#error_message" ).html( "<p>Please select any one option</p>" );
            }
            });
