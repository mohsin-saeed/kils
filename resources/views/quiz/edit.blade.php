...
<div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                <?php $conter=1;?>
                  <h3 style="margin-left: 34%;"><b>Edit Quiz</b></h3>
                ...
                <div class="x_content">
                  ...
                  <form  method="post" action="<?php echo url()?>/quiz/edit/<?=$question->id?>">
                       ...
                       <div class="form-group">
                                           <label class="col-md-4 control-label">Category Name</label>
                                                                   <div class="col-md-6">
                                                                     ...
                                                                     <?php echo Form::select('categories_id', $categories, $question->categories_id, array('class' => 'form-control')) ?>
