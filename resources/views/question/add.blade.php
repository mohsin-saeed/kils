...
<div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                <?php $conter=1;?>
                  <h3 style="margin-left: 34%;"><b>Add Question</b></h3>
                       ...
                       <div class="form-group">
                                           <label class="col-md-4 control-label">Quiz Name</label>
                                                                   <div class="col-md-6">
                                                                     ...
                                                                     <?php echo Form::select('quiz_id', $quiz, null, array('class' => 'form-control')) ?>
                                           ...
                                           <label class="col-md-4 control-label">Option A</label>
                                             <div class="col-md-6">
                                                        <div class="@if ($errors->has('option_a')) has-error @endif">
                                                         <input type="text" name="option_a" value="{{Input::old('option_a')}}" class="form-control input-circle" placeholder="Enter option a">
               ...
               <br><br>
                        ...
                        <label class="col-md-4 control-label">Option B</label>
                         <div class="col-md-6">
                             <div class="@if ($errors->has('option_b')) has-error @endif">
                               <input type="text" name="option_b" value="{{Input::old('option_b')}}" class="form-control input-circle" placeholder="Enter option b">
                ...
                <div class="form-group">
                     ...
                     <input type="text" name="option_c" value="{{Input::old('option_c')}}" class="form-control input-circle" placeholder="Enter option c">
                  ...
                  <div class="@if ($errors->has('option_d')) has-error @endif">
                   <input type="text" name="option_d" value="{{Input::old('option_d')}}" class="form-control input-circle" placeholder="Enter option d">
                     ...
                     <div class="form-group">
                       <label class="col-md-4 control-label">IS Correct</label>
                                               <div class="col-md-6">
                                                 ...
                                                 <?php echo Form::select('is_correct', array('1' => 'A', '2' => 'B','3'=>'C','4'=>'D'), null, array('class' => 'form-control')) ?>
