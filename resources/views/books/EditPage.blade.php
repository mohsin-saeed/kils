...
<div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <h3 style="text-align: center"><b>Edit Page # <?php echo $data->id?></b></h3>

                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  <br>
                  <form id="demo-form2"  class="form-horizontal form-label-left" method="post" action="<?php echo url();?>/UpdatePageRecord/<?php echo $data->id?>" enctype="multipart/form-data">
